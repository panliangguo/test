...
// 我的项目
const Myproject = LoadableComponent(()=>import('../../routes/Myproject/index'))
// 项目管理
const ProjectManagement = LoadableComponent(()=>import('../../routes/ProjectManagement/index'))
// 数据分析
const DataAnalysis = LoadableComponent(()=>import('../../routes/dataA/DataAnalysis/index'))
const TerminalData = LoadableComponent(()=>import('../../routes/dataA/TerminalData/index'))
    ...
    return (
      <div style={{padding: 16, position: 'relative'}}>
        <Switch>
          ...
          {/* 我的项目 */}
          <PrivateRoute exact path='/home/Myproject' component={Myproject}/>
          {/* 项目管理 */}
          <PrivateRoute exact path='/home/ProjectManagement' component={ProjectManagement}/>
           {/* 数据分析 */}
          <PrivateRoute exact path='/home/dataA/DataAnalysis' component={DataAnalysis}/>
          <PrivateRoute exact path='/home/dataA/TerminalData' component={TerminalData}/>
